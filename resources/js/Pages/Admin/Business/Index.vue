  ...
  <admin-layout title="Businesses">
    <div class="container grid px-6 mx-auto">
      ...
      <!-- <Link
        ...
        "
        :href="route('kitchn.business.create')"
      >
        <span>Create Business &plus;</span>
      </Link> -->
      ...
      <div class="flex justify-between w-full">
        ...
        <span class="flex gap-3"
          ><jet-input
            ...
            class="mt-1 block w-full md:w-1/2 mb-10"
          />
          <jet-input
            type="date"
            id="end_date"
          ...
          <table class="w-full whitespace-no-wrap">
              ...
              >
                ...
                <th class="px-4 py-3">
                  <span
                    ...
                    <svg
                      v-if="
                        params.field === 'role' && params.direction === 'asc'
                      "
                      xmlns="http://www.w3.org/2000/svg"
                      class="h-3 w-3"
                      viewBox="0 0 20 20"
            ...
            >
              ...
              >
                <td class="px-4 py-3">
                  <Link
                    :href="route('kitchn.business.show', { business: user })"
                  >
    ...
    del(user) {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          this.$inertia.delete(route("kitchn.business.destroy", { id: user }), {
            onSuccess: (response) => {
  ...
  watch: {
    params: {
      handler: _.throttle(function () {
        ...
        this.$inertia.get(this.route("kitchn.business.index"), params, {
          replace: true,
          preserveState: true,
        });
      }, 150),

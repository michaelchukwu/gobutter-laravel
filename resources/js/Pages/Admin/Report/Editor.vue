<template>
  <admin-layout title="Reports">
    <div class="container px-6 mx-auto grid">
      ...
      <div>
        <page-view-chart :pageviews="pageviews"></page-view-chart>
      </div>
    </div>
  </admin-layout>
</template>
...
import PageViewChart from "../../../Bits/PageViewChart.vue";
export default {
  components: {
    AdminLayout,
    Link,
  ...
  //   props: ["total_users", "total_tickets", "total_closed", "total_open"],
};
</script>

  ...
  <admin-layout title="Services">
    <div class="container grid px-6 mx-auto">
      ...
      <Link
        ...
        "
        :href="route('kitchn.service.create')"
      >
        <span>Create Service &plus;</span>
      </Link>
        ...
        <div class="w-full overflow-x-auto">
          <table class="w-full whitespace-no-wrap">
            ...
            >
              ...
              >
                <td class="px-4 py-3">
                  <Link :href="route('kitchn.service.edit', { service: user })">
                ...
                <td class="px-4 py-3">
                  <div class="flex items-center space-x-4 text-sm">
                    <Link
                      :href="route('kitchn.service.edit', { service: user })"
                      class="
                        flex
                        items-center
                        justify-between
    ...
    del(user) {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          this.$inertia.delete(route("kitchn.service.destroy", { id: user }), {
            onSuccess: (response) => {
  ...
  watch: {
    params: {
      handler: _.throttle(function () {
        ...
        this.$inertia.get(this.route("kitchn.service.index"), params, {
          replace: true,
          preserveState: true,
        });
      }, 150),

  ...
  <admin-layout title="Menu">
    <div class="container grid px-6 mx-auto">
      ...
      <Link
        ...
        "
        :href="route('kitchn.menu.create')"
      >
        <span>Create Menu &plus;</span>
      </Link>
        ...
        <div class="w-full overflow-x-auto">
          <table class="w-full whitespace-no-wrap">
              ...
              >
                ...
                <th class="px-4 py-3">
                  <span
                    ...
                    <svg
                      v-if="
                        params.field === 'url' && params.direction === 'asc'
                      "
                      xmlns="http://www.w3.org/2000/svg"
                      class="h-3 w-3"
                      viewBox="0 0 20 20"
                    ...
                    <svg
                      v-if="
                        params.field === 'url' && params.direction === 'desc'
                      "
                      xmlns="http://www.w3.org/2000/svg"
                      class="h-3 w-3"
                      viewBox="0 0 20 20"
            ...
            >
              ...
              >
                <td class="px-4 py-3">
                  <Link :href="route('kitchn.user.edit', { user: user })">
                ...
                <td class="px-4 py-3">
                  <div class="flex items-center space-x-4 text-sm">
                    <Link
                      :href="route('kitchn.menu.edit', { menu: user })"
                      class="
                        flex
                        items-center
                        justify-between
    ...
    del(user) {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          this.$inertia.delete(route("kitchn.menu.destroy", { id: user }), {
            onSuccess: (response) => {
  ...
  watch: {
    params: {
      handler: _.throttle(function () {
        ...
        this.$inertia.get(this.route("kitchn.menu.index"), params, {
          replace: true,
          preserveState: true,
        });
      }, 150),

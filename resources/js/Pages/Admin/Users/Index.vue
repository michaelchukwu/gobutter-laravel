            ...
            >
              ...
              >
                ...
                <td class="px-4 py-3 text-xs">
                  ...
                  >
                  -->
                  <span class="mx-1" v-for="r in user.departments" :key="r.id">
                    {{ r.title }}
                  </span>
                  <!-- </span> -->
                </td>
                <td class="px-4 py-3 text-xs">
                  <span
                    ...
                    "
                  >
                    <span class="mx-1" v-for="r in user.roles" :key="r.id">
                      {{ r.name }}
                    </span>
                  </span>
                </td>
                ...
                <td class="px-4 py-3">
                  <div class="flex items-center space-x-4 text-sm">
                    <Link
                      :href="route('kitchn.user.edit', { user: user })"
                      class="
                        flex
                        items-center
                        justify-between
    ...
    del(user) {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          this.$inertia.delete(route("kitchn.user.destroy", { id: user }), {
            onSuccess: (response) => {
  ...
  watch: {
    params: {
      handler: _.throttle(function () {
        ...
        this.$inertia.get(this.route("kitchn.user.index"), params, {
          replace: true,
          preserveState: true,
        });
      }, 150),

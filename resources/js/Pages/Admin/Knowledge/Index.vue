<template>
  <admin-layout title="Knowledgebase">
    <div class="container grid px-6 mx-auto">
      ...
      <div
        ...
        "
      >
        <Link :href="route('kitchn.knowledge.create')">
          <span>Create Knowledgebase &plus;</span>
        </Link>
        <button @click="toggleSectionModal">
          <span>Create Sections &plus;</span>
        </button>
      </div>
              ...
              >
                <th class="px-4 py-3">
                  <span
                    ...
                    <svg
                      v-if="
                        params.field === 'title' && params.direction === 'asc'
                      "
                    ...
                    <svg
                      v-if="
                        params.field === 'title' && params.direction === 'desc'
                      "
                      xmlns="http://www.w3.org/2000/svg"
                      class="h-3 w-3"
                      viewBox="0 0 20 20"
                ...
                <th class="px-4 py-3">
                  <span
                    ...
                    <svg
                      v-if="
                        params.field === 'author' && params.direction === 'asc'
                      "
                      xmlns="http://www.w3.org/2000/svg"
                      class="h-3 w-3"
                      viewBox="0 0 20 20"
                    ...
                    <svg
                      v-if="
                        params.field === 'author' && params.direction === 'desc'
                      "
                      xmlns="http://www.w3.org/2000/svg"
                      class="h-3 w-3"
                      viewBox="0 0 20 20"
                ...
                <th class="px-4 py-3">
                  <span
                    ...
                    <svg
                      v-if="
                        params.field === 'views' && params.direction === 'asc'
                      "
                      xmlns="http://www.w3.org/2000/svg"
                      class="h-3 w-3"
                      viewBox="0 0 20 20"
                    ...
                    <svg
                      v-if="
                        params.field === 'views' && params.direction === 'desc'
                      "
                      xmlns="http://www.w3.org/2000/svg"
                      class="h-3 w-3"
                      viewBox="0 0 20 20"
                ...
                <th class="px-4 py-3">
                  <span
                    ...
                    <svg
                      v-if="
                        params.field === 'section' && params.direction === 'asc'
                      "
                      xmlns="http://www.w3.org/2000/svg"
                      class="h-3 w-3"
                      viewBox="0 0 20 20"
            ...
            >
              ...
              >
                <td class="px-4 py-3">
                  <Link
                    :href="
                      route('kitchn.knowledge.edit', { knowledge: user.id })
                    "
                  >
...
export default {
  ...
  methods: {
    ...
    submit() {
      this.form.post(this.route("kitchn.section.store"), {
        onSuccess: () => {
    ...
    del(user) {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          this.$inertia.delete(
            route("kitchn.knowledge.destroy", { id: user }),
            {
              onSuccess: (response) => {
  ...
  watch: {
    params: {
      handler: _.throttle(function () {
        ...
        this.$inertia.get(this.route("kitchn.knowledge.index"), params, {
          replace: true,
          preserveState: true,
        });
      }, 150),

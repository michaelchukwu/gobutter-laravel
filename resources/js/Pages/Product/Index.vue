    ...
    <div class="w-full">
      ...
      >
        ...
        <div class="w-full lg:w-3/4 py-12 px-6">
          <div class="text-4xl">Gift Items</div>
          <div class="text-lg mt-4 font-light">
            What would you like to have ?
          </div>
          <div>
              <div class="grid grid-cols-1 md:grid-cols-3 2xl:grid-cols-6">
                  <div class="rounded border border-gray-500 h-44">
                      <img src="/img/iphone.jpg" alt="" class="h-3/4 w-full">
                      <div>something</div>
                  </div>
              </div>
          </div>
